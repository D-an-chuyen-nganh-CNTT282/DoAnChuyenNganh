    ...
    public partial class DbInit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CorporatePartnerId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CorporatePartner", x => x.CorporatePartnerId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncomingDocuments", x => x.IncomingDocumentsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OutgoingDocument", x => x.OutgoingDocumentId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeachingSchedule", x => x.TeachingScheduleId);
                    table.ForeignKey(
                        name: "FK_TeachingSchedule_Faculty_FacultyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActionNotificationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActionNotification", x => x.ActionNotificationId);
                    table.ForeignKey(
                        name: "FK_ActionNotification_IncomingDocuments_IncomingDocumentId",
                        column: x => x.IncomingDocumentId,
                        principalTable: "IncomingDocuments",
                        principalColumn: "IncomingDocumentsId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    CorporatePartnerId = table.Column<int>(type: "int", nullable: false),
                    InternshipDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Internship_CorporatePartner_CorporatePartnerId",
                        column: x => x.CorporatePartnerId,
                        principalTable: "CorporatePartner",
                        principalColumn: "CorporatePartnerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentRequest", x => x.StudentRequestId);
                    table.ForeignKey(
                        name: "FK_StudentRequest_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActionNotification_IncomingDocumentId",
                table: "ActionNotification",
                column: "IncomingDocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_Internship_CorporatePartnerId",
                table: "Internship",
                column: "CorporatePartnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeachingSchedule_FacultyId",
